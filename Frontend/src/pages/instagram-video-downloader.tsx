...
export default function AllVideoDownloader({
  ...
  const visiblePlatforms = t("instagramVedioDownloader.ui.platformButtons", {
    returnObjects: true,
...
const platformLinks: { name: string; href: string; icon: string }[] = [
  ...
  return (
    <>
      {/* ✅ Localized HeadSEO */}
      <HeadSEO page="instagram-video-downloader" seoData={headSeoData} locale={locale} />
       <HeaderComponent
        navLinks={navLinks}
        languages={languages}
          ...
          >
            <VStack spacing={4} textAlign="center">
              <Heading as="h1" size="lg">
                {t("instagramVedioDownloader.ui.title")}
              </Heading>
              <Text maxW="680px" mx="auto">
                {t("instagramVedioDownloader.ui.subtitle")}
              </Text>
            </VStack>
            ...
            <Box mt={6} p={4} rounded="xl" bg="#444444" maxW="800px" mx="auto">
              <Flex bg="white" align="center" p={2} rounded="md" gap={2} maxW="800px" mx="auto">
                <Input
                  flex="1"
                  placeholder={t("instagramVedioDownloader.ui.inputPlaceholder") || ""}
                  value={url}
...
>
  {loading ? (
    <>
      {t("instagramVedioDownloader.ui.downloadBtn.loading")}
      <span style={{ marginLeft: "8px" }}>
        <PulseLoader color="#ffffff" margin={1} size={6} />
      </span>
    </>
  ) : (
    t("instagramVedioDownloader.ui.downloadBtn.idle")
  )}
</Button>
...
const languages = [
  ...
  const routeKey = "instagramVedioDownloader";
  const headSeoData = headSeoJson["instagramVedioDownloader"] || {};
