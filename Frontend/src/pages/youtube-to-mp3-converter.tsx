...
//   const visiblePlatforms = t("youtubeToMp3Downloader.ui.platformButtons", {
//     returnObjects: true,
...
//     <>
//       {/* ✅ Localized HeadSEO */}
//       <HeadSEO page="youtube-to-mp3-downloader" seoData={headSeoData} locale={locale} />
...
//                 {t("youtubeToMp3Downloader.ui.title")}
//               </Heading>
//               <Text maxW="680px" mx="auto">
//                 {t("youtubeToMp3Downloader.ui.subtitle")}
//               </Text>
//             </VStack>
...
//                 <Input
//                   flex="1"
//                   placeholder={t("youtubeToMp3Downloader.ui.inputPlaceholder") || ""}
//                   value={url}
...
//               {loading ? (
//                 <>
//                   {t("youtubeToMp3Downloader.ui.downloadBtn.loading")}
//                   <span style={{ marginLeft: "8px" }}>
//                     <PulseLoader color="#ffffff" margin={1} size={6} />
//                   </span>
//                 </>
//               ) : (
//                 t("youtubeToMp3Downloader.ui.downloadBtn.idle")
//               )}
//             </Button>
//               </Flex>
...
//                     >
//                       {p.name} {t("youtubeToMp3Downloader.ui.downloadBtn.idle")}
//                     </Button>
//                   </WrapItem>
//                 ))}
//               </Wrap>
...
//   const routeKey = "youtubeToMp3Downloader";
//   const headSeoData = headSeoJson["twitterVedioDownloader"] || {};
...
const platformLinks: { name: string; href: string; icon: string }[] = [
  ...
  return (
    <>
      {/* ✅ Localized HeadSEO */}
      <HeadSEO page="youtube-to-mp3-converter" seoData={headSeoData} locale={locale} />
       <HeaderComponent
        navLinks={navLinks}
        languages={languages}
...
const languages = [
  ...
  const routeKey = "youtubeToMp3Downloader";
  const headSeoData = headSeoJson["youtubeToMp3Downloader"] || {};
