...
export default function AllVideoDownloader({
  ...
  const visiblePlatforms = t("allVideoDownloader.ui.platformButtons", {
    returnObjects: true,
...
const platformLinks: { name: string; href: string; icon: string }[] = [
  ...
  return (
    <>
      {/* ✅ Localized HeadSEO */}
      <HeadSEO page="" seoData={headSeoData} locale={locale} />
       <HeaderComponent
        navLinks={navLinks}
        languages={languages}
          ...
          >
            <VStack spacing={4} textAlign="center">
              <Heading as="h1" size="lg">
                {t("allVideoDownloader.ui.title")}
              </Heading>
              <Text maxW="680px" mx="auto">
                {t("allVideoDownloader.ui.subtitle")}
              </Text>
            </VStack>
            ...
            <Box mt={6} p={4} rounded="xl" bg="#444444" maxW="800px" mx="auto">
              <Flex bg="white" align="center" p={2} rounded="md" gap={2} maxW="800px" mx="auto">
                <Input
                  flex="1"
                  placeholder={t("allVideoDownloader.ui.inputPlaceholder") || ""}
                  value={url}
...
>
  {loading ? (
    <>
      {t("allVideoDownloader.ui.downloadBtn.loading")}
      <span style={{ marginLeft: "8px" }}>
        <PulseLoader color="#ffffff" margin={1} size={6} />
      </span>
    </>
  ) : (
    t("allVideoDownloader.ui.downloadBtn.idle")
  )}
</Button>
              </Flex>
...
const navLinks = [
    { label: "TikTok downloader", href: "/tiktok-video-downloader" },
    { label: "YouTube downloader", href: "/youtube-video-downloader" },
...
const languages = [
  ...
  const routeKey = "allVideoDownloader";
  const headSeoData = headSeoJson["allVideoDownloader"] || {};
