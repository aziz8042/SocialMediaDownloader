...
//   const visiblePlatforms = t("facebookVedioDownloader.ui.platformButtons", {
//     returnObjects: true,
...
//     <>
//       {/* ✅ Localized HeadSEO */}
//       <HeadSEO page="facebook-video-downloader" seoData={headSeoData} locale={locale} />
...
//                 {t("facebookVedioDownloader.ui.title")}
//               </Heading>
//               <Text maxW="680px" mx="auto">
//                 {t("facebookVedioDownloader.ui.subtitle")}
//               </Text>
//             </VStack>
...
//                 <Input
//                   flex="1"
//                   placeholder={t("facebookVedioDownloader.ui.inputPlaceholder") || ""}
//                   value={url}
...
//               {loading ? (
//                 <>
//                   {t("facebookVedioDownloader.ui.downloadBtn.loading")}
//                   <span style={{ marginLeft: "8px" }}>
//                     <PulseLoader color="#ffffff" margin={1} size={6} />
//                   </span>
//                 </>
//               ) : (
//                 t("facebookVedioDownloader.ui.downloadBtn.idle")
//               )}
//             </Button>
//               </Flex>
...
//                     >
//                       {p.name} {t("facebookVedioDownloader.ui.downloadBtn.idle")}
//                     </Button>
//                   </WrapItem>
//                 ))}
//               </Wrap>
...
//   const routeKey = "facebookVedioDownloader";
//   const headSeoData = headSeoJson["facebookVedioDownloader"] || {};
